...
class JamiDusu
{
    ...
    */
    private function yeanhae($year_e)
    {
        ...
        switch ($year_e) {
            case '子': $yeanhae_09 = '연해';
                break;
            case '丑': $yeanhae_08 = '연해';
                break;
            case '寅': $yeanhae_07 = '연해';
                break;
            case '卯': $yeanhae_06 = '연해';
                break;
            case '辰': $yeanhae_05 = '연해';
                break;
            case '巳': $yeanhae_04 = '연해';
                break;
            case '午': $yeanhae_03 = '연해';
                break;
            case '未': $yeanhae_02 = '연해';
                break;
            case '申': $yeanhae_01 = '연해';
                break;
            case '酉': $yeanhae_12 = '연해';
                break;
            case '戌': $yeanhae_11 = '연해';
                break;
            case '亥': $yeanhae_10 = '연해';
                break;
        }
        return $yeanhae;
    }
