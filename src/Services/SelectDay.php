...
class SelectDay
{
  ...
  public function calMoveDay($yyyymmdd, $sajuwha, $profile) {
    $birth_date = $sajuwha->no;
        ...
        if (($sum_day_e == $senggi_01)||($sum_day_e == $senggi_02)) {$titles['senggi'] = '생기'; $scores['sbc'] = 30;}
		if (($sum_day_e == $bokduk_01)||($sum_day_e == $bokduk_02)) {$titles['bokduk'] = '복덕'; $scores['sbc'] = 30;}
		if (($sum_day_e == $cheneu_01)||($sum_day_e == $cheneu_02)) {$titles['cheneu'] = '천의'; $scores['sbc'] = 30;}
